...
/*
 * @Author: shawnxiao
 * @Date: 2021-04-11 17:16:34
 * @LastEditTime: 2021-04-15 10:51:57
 * @FilePath: /webpack5-ts-pages/src/index/Layout/components/LayoutSettings/index.tsx
 */
...
import { actionCreators } from '@/index/store/settings'
...
interface LayoutSettings {
 ...
 const LayoutSettings = (props:LayoutSettings) => {
...
const mapDispatchToProps = {
  updateLayoutSettings: actionCreators.updateLayoutSettings
}

export default connect(mapStateToProps, mapDispatchToProps)(memo(LayoutSettings))
